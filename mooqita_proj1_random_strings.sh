...
MiB_to_byte=1000                        # This is the real 1048576 MiB_to_byte value substitute after '=' if you wish
...
sort_random_strings_file() {
	sort -f ~/random_strings_file -o ~/random_strings_file  # Sorting with no importance to case
	echo -e "\nSorted file:\n"
